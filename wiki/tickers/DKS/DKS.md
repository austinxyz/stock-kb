...
On August 25 DKS fell **30.7% in one session, the worst day in its history**, on a FY2026 guidance cut. Read the cut by segment and it is not company-wide: of the ~$260M reduction in operating income, **~$190M is Foot Locker** (segment profit +$110–150M → a $40–80M *loss*) and ~$70M is DICK'S margin. The DICK'S comp guide did not move, after a quarter that comped **+4.9%** with gross margin **+79 bps** and ~200 bps of share gain in a declining industry.
...
Two segments, different economics. The **DICK'S Business** (892 stores, 46.0M sq ft: DICK'S, House of Sport, Field House, Golf Galaxy, Going Going Gone!, Public Lands, plus GameChanger) did record FY2025 sales of $14.11B on +4.5% comps. The **Foot Locker Business** (2,212 owned doors, 11.6M sq ft) was bought in September 2025 for $2.5B, 84% in stock at ≈$219, and is being cut hard: 110 doors closed in H1, WSS from 143 to 99.

### Driver tree

*Source: [Q2 FY2026 10-Q](https://www.sec.gov/Archives/edgar/data/1089063/000108906326000036/dks-20260801.htm), [FY2025 10-K](../../../raw/DKS/filings/2026-03-27_10-K-FY2025.txt). Per-unit figures `[Derived]` unless disclosed.*

| | DICK'S Business | Foot Locker Business |
|---|---|---|
| Unit | Store (892; 46.0M sq ft) | Store (2,212 owned; 11.6M sq ft) |
| Sales / sq ft | ≈$312 (FY2025) | ≈$608 (H1 FY2026 annualized) |
| Sales / door | ≈$15.8M | ≈$3.3M |
| Contribution / unit | Segment margin ≈10.7% of sales (FY2026 guide); four-wall n/d | Segment loss $(31.9)M in Q2; four-wall n/d |
| New-unit return | n/d — management calls House of Sport "highly profitable"; no per-store disclosure. Proxy: House of Sport 110K sq ft/door vs 53K legacy, 41 → ~55 doors by end-2026 | n/a — closing doors, not opening |
| Growth split FY2025 | Comps +4.5% (per unit) vs sq ft +1.6% (units): ~75% per-unit | Proforma comp −1.6% H1; doors −4% |

### Five-year record

*Company fiscal convention; FY2025 ended Jan 31, 2026 and includes ~5 months of Foot Locker; FY2023 was 53 weeks. Source: [SEC XBRL company facts](https://data.sec.gov/api/xbrl/companyfacts/CIK0001089063.json); capital rows `[Derived]`: invested capital = equity + senior notes + operating leases − cash; NOPAT at the reported tax rate.*
...
| Gross capex | 308 | 364 | 587 | 803 | **1,137** | **~1,400 net** |
| **Free cash flow** | 1,309 | 558 | 940 | 509 | **400** | ⚠️ H1: **49** |
| Dividends paid | 603 | 163 | 351 | 362 | **414** | ~450 |
| Invested capital | 3,542 | 4,750 | 5,082 | 5,997 | **11,900** | — |
| **ROIC** (lease-inclusive) | 43.8% | 23.2% | 20.0% | 18.9% | **6.8%** | — |
| 3-yr incremental ROIC | — | — | — | — | **−4.0%** | — |
| Reinvestment rate | — | — | — | — | ≈129% | — |
| SBC % of sales | 0.4% | 0.4% | 0.4% | 0.5% | 0.7% | — |
| FCF conversion (FCF ÷ NI) | — | — | 90% | 44% | 47% | — |
...
| DICK'S segment profit | $361M | $485M |
| Foot Locker segment profit | $17M | **$(32)M** |
...
|---|---|---|---|---|---|
| Market growth | ~0 | Indefinite, low | ~$120.6B US market ([IBISWorld](https://www.ibisworld.com/united-states/market-size/sporting-goods-stores/1079/)); footwear cycle mid-correction | Ride it out | Proven |
| Share gain (new formats + capacity exit) | +1–2 pts | 3–5 yrs | ~200 bps Q2 share gain; Hibbett/WSS/Foot Locker doors closing; ~14 House of Sport + 20 Field House openings in 2026 | *"No better time… when the market is in turmoil"* (Stack, Q2 call) | Proven |
| Price and mix | Negative | — | Chose price over margin in Q2; premium formats lift mix | Promotional "at least through Q4" | Option |
| Attach / new products | ~+1 pt, margin-accretive | 5+ yrs | GameChanger ~$150M at ~40% CAGR; Media Network ~20B impressions; ScoreCard+ $99/yr tier | Expand all three | Scaling |
| New geographies | ~0 | — | Foot Locker Europe 559 doors, APAC 92: inherited, shrinking | Prune | Option |
| M&A | Negative | — | Foot Locker consumed the incremental return (§1); no further deals signaled | Integrate | Proven (negative) |
| Margin | The swing factor: ±$400M | 2–4 yrs | FL from $(60)M to Bull ~5% on $8B; DICK'S segment margin 10.7% → 11% Base | Fast Break to 300–350 doors; no FL profitability date given | Scaling |
| Share count | 0 | $3.0B authorized | 90M shares; $141M bought in H1 at $196; nothing since the crash | Silent | Option (unused) |

The Base case rests on **share gain plus a Foot Locker margin recovery to ~1.5%**; the Bull needs Foot Locker at 5% and the buyback used. None of the levers above is an adjacency problem: every one shares the customer, the vendor relationships and the store base with the core.

## 3. Moat, Customer & Competition

| Read | Call | Evidence |
|---|---|---|
| Mechanism | **Cornered resource** + **scale economies** | Allocation privilege: the largest US wholesale door gets depth and launch exclusivity subscale rivals cannot; scale in vendor terms and the Media Network |
| Trend | **Narrowing** | Chose price over margin in Q2; segment margin guide −45 bps; Q3 gross margin flagged as the worst of the cycle |
| Profit pool | Brands capture it | Nike ≈31% of merchandise purchases on short-term POs with no long-term contract; its DTC retreat returned some margin to wholesale, a reprieve not a settlement |
| Customer | US athletes and families buying at the start of each season | ScoreCard's ~30M active members drive >75% of DICK'S sales, Gold >50%; GameChanger acquires families early; pricing power none this cycle; CAC/LTV n/d |

**Narrow, narrowing**: no switching costs, and a moat that must discount to hold volume.

| Competitor | Position | Threat |
|---|---|---|
| **Nike (DTC)** | ~35% US brand share; DKS's largest vendor | The dependency and the threat at once. At a 12-year low ([NKE](../NKE/NKE.md)), so the brand cycle driving DKS's promotions is unfixed. |
| **JD Sports (+Hibbett)** | Global sneaker retail | Direct Foot Locker rival with the same mall exposure, also closing ~175 Hibbett doors. Capacity is leaving the channel. |
| **Academy Sports** | ~$6B value-oriented | Real share competitor in DICK'S core, positioned to absorb closing WSS and Hibbett doors. |
...
**Industry**: the footwear cycle is clearing inventory through promotion and rotating from legacy retro silhouettes toward performance product, precisely Foot Locker's over-exposure. The whole complex is drawn down together ([NKE](../NKE/NKE.md), [ONON](../ONON/ONON.md) −43%, [LULU](../LULU/LULU.md) near multi-year lows), which argues category rather than DKS execution, and equally means nothing ends it soon.

## 4. Management & Capital

**Lauren Hobart** (CEO since 2021) runs the company; **Ed Stack** (Executive Chairman, running it since 1984) still oversees merchandising and personally leads the Foot Locker integration. Governance is **dual-class**: Stack, relatives and family trusts control a majority of combined voting power (65.4M common, 23.6M Class B).

**Incentives**: annual cash incentive is paid on **Adjusted Non-GAAP EBT**; performance units are gated on an **Adjusted Non-GAAP EBT threshold** with goals "aligned with Company initiatives" ([2026 proxy](https://www.sec.gov/Archives/edgar/data/1089063/000108906326000015/dks-20260501.htm)). No return-on-capital or free-cash-flow metric anywhere in the plan. **Guidance grade: Mixed, deteriorating**: EPS beat consensus in six of eight quarters, then missed twice running (−$0.01, −$0.21), with a raise in May followed by a 19% cut in August ([MarketBeat](https://www.marketbeat.com/stocks/NYSE/DKS/earnings/)). Hobart sold **$4.6M at $228** on May 28, twelve weeks before the crash; Stack sold $41.6M at $198 on March 31.

**Promises ledger**

| Promised | Where, when | Outcome |
|---|---|---|
| Foot Locker *"inflection point in both sales and profitability"* at back-to-school | [FY2025 letter](../../../raw/DKS/shareholder-letters/2025_letter.txt), May 2026 | 🔴 −3.6% comp, $(32)M loss |
...
| **Goodwill impairment** on $591M of Foot Locker goodwill | Med | Med | No | Any write-down: management conceding it is worth less than paid |
